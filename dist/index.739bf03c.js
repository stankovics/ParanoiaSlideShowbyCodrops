...
const slidesshowNavPrev = new _slideshow.Slideshow(document.querySelector('.slideshow nav.nav--prev .slides'), {
    duration: 1,
    filterAnimation: false
});
...
class Slideshow {
    ...
    constructor(DOM_el, options = {
        ...
        this.filterAnimation = options.filterAnimation != undefined ? options.filterAnimation : this.filterAnimation;
