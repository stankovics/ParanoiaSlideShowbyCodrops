...
const slideshowNavPrev = new _slideshow.Slideshow(document.querySelector('.slideshow nav.nav--prev .slides'), {
    duration: 1,
    filtersAnimation: false
});
...
const onClickNavCtrlEv = (dir)=>{
    ...
    _gsapDefault.default.to(titleElems[slideshowMain.current], {
        duration: slideshowMain.duration / 2,
        ease: 'power3.in',
        y: dir === 'next' ? '-100%' : '100%',
        opacity: 0
...
_utils.preloadImages('.slides__img-inner').then(()=>document.body.classList.remove('loading')
);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ao8JN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Slideshow {
    ...
    constructor(DOM_el, options = {
        ...
        this.DOM.slides.forEach((slideEl)=>this.slidesArr.push(new _slide.Slide(slideEl))
        );
   ...
   */ navigate(position = this.current) {
        ...
        .to(this.currentSlide.DOM.outer, {
            ...
            onComplete: ()=>_gsap.gsap.set(this.currentSlide.DOM.outer, {
                    x: '0%',
                    opacity: 0
                })
        }, 'start').to(this.currentSlide.DOM.inner, {
            x: this.direction === 'next' ? '101%' : '-101%',
            onComplete: ()=>_gsap.gsap.set(this.currentSlide.DOM.inner, {
                    x: '0%'
                })
        }, 'start');
        // Filters animation
...
},{"gsap":"fPSuC","./slide":"a2l79","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"a2l79":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
},{"gsap/gsap-core":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"72Dku":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequire0037")
